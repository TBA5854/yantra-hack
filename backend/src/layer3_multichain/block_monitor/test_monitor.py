...
async def test_ethereum_monitor():
    ...
    from src.layer3_multichain.block_monitor.monitor import EthereumBlockMonitor
...
async def test_arbitrum_monitor():
    ...
    from src.layer3_multichain.block_monitor.monitor import ArbitrumBlockMonitor
...
async def test_solana_monitor():
    ...
    from src.layer3_multichain.block_monitor.monitor import SolanaBlockMonitor
